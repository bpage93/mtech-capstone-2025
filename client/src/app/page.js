        ...
        if (mode === "signup") {
            ...
            for (let field in fields) {
                ...
                if (!fields[field]) {
                    ...
                    document.getElementById("field-warning").innerText =
            ...
            <div className="flex flex-col gap-y-3 rounded-xl p-5 w-full max-w-120 bg-base-200 shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-y-3">
                    ...
                    >
                        ...
                        <div className="relative flex items-center w-full">
                            <input
                                ...
                                className="input w-full pr-10 !z-0"
                                value={password}
                    ...
                    <button
                        ...
                        type="submit"
                        className="btn w-full text-base !h-11 border-white my-2 hover:from-purple-900 hover:via-black hover:to-black hover:bg-gradient-to-r"
                    >
