		...
		<PageLoader>
			<div className="space-y-6">
				...
				<div className="flex flex-col sm:flex-row items-center gap-4">
					<input type="text" placeholder="Search courses..." className="input input-bordered w-full sm:w-1/2" />
					...
					{[1, 2, 3].map((id) => (
						<div key={id} className="card bg-base-200 shadow-md">
							<div className="card-body">
								...
								<p>Short description of the course goes here. Topics covered, etc.</p>
