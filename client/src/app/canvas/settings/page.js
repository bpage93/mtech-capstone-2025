		...
		<PageLoader>
			<div className="min-h-screen bg-base-200 flex justify-center items-center p-6">
				<div className="card bg-base-100 shadow-xl w-full max-w-2xl p-6">
					...
					<SettingsForm name={name} setName={setName} email={email} setEmail={setEmail} password={password} setPassword={setPassword} role={role} setRole={setRole} theme={theme} setTheme={setTheme} handleSave={handleSave} />
				</div>
			</div>
		</PageLoader>
	);
